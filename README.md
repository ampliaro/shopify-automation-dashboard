...
> Dashboard profissional com métricas visuais, drill-down interativo e dark mode
...
│  [ Hoje ] [ 7 dias ] [ 30 dias ]                       │
├─────────────────────────────────────────────────────────┤
│  📦 Pedidos    ✅ Sucesso    ⚠️ Falhas    ⏱️ Tempo    │
│    54           61.1%          12          5 min       │
│  +184.2% ↑    -23.1% ↓      +300% ↑                   │
├─────────────────────────────────────────────────────────┤
│               📈 Gráfico de Tendências                 │
│  [Linha do tempo interativa com 4 séries]             │
├─────────────────────────────────────────────────────────┤
│  🔍 Buscar...  | Status: [Todos ▼] | Total: 54       │
├─────────────────────────────────────────────────────────┤
│  📋 Tabela de Pedidos (clicável para detalhes)        │
└─────────────────────────────────────────────────────────┘
```
